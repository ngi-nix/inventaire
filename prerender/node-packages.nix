...
let
  sources = {
    ...
    "config-3.3.4" = {
      ...
      version = "3.3.4";
      src = fetchurl {
        url = "https://registry.npmjs.org/config/-/config-3.3.4.tgz";
        sha512 = "URO0m6z+rtENGHqtzO7W7C35iF+H9KVe7JJFps+3TIqZEOHl83NqTAgp5h8ah96m4NPQnx08nPBfbtDU+PgjVA==";
      };
    };
    ...
    "prerender-level-cache-3.0.1" = {
      name = "prerender-level-cache";
      packageName = "prerender-level-cache";
      version = "3.0.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/prerender-level-cache/-/prerender-level-cache-3.0.1.tgz";
        sha512 = "EwEy9C/WthTmaVQCHzCjbLLZfAs2Unp6A7hjviUCLvi2zCxZNpIxX4X1HxZkLjIJ6ycWhbo+9eUi2xmxKRF+Yg==";
      };
    };
...
in
{
  "prerender-git://github.com/inventaire/prerender.git" = nodeEnv.buildNodePackage {
    ...
    src = fetchgit {
      ...
      rev = "8659035639da32ddff28fa7ba694431ac6a53ad8";
      sha256 = "5f8a046c7481506c7725dbeee1352a249cbe99391edcccfffcdd842358aaecfc";
    };
    dependencies = [
      ...
      sources."prerender-level-cache-3.0.1"
